...
public:
    ...
    void set_points(const std::vector<std::pair<double, double>>& values, bool cubic_spline=true);
...
void spline::set_points(const std::vector<std::pair<double, double> >& values, bool cubic_spline) {
    std::vector<double> x;
    std::vector<double> y;
